...
const Classroom = () => {
    ...
    const { data: classroom } = useQuery({
        ...
        queryFn: async () => {
            ...
            return axios.get<ClassroomProps>(
    ...
    return (
        <>
            <Head>
                ...
                <meta itemProp="name" content="OnRoom | Classroom" />
                <meta
                ...
                <meta property="og:title" content="OnRoom | Classroom" />
                <meta
                ...
                <meta name="twitter:title" content="OnRoom | Classroom" />
                <meta
            ...
            <main className="flex flex-col gap-y-4 flex-1 h-full px-3 py-4 bg-gray-100 md:py-10 dark:bg-back md:px-8 lg:px-12  ">
                ...
                {isUnEnrollModal && (
                    <Modal
                        isOn={isUnEnrollModal}
                        toggleOn={toggleUnEnrollModal}
                    >
                        <ConfirmationModal
                            name={classroom?.data.title}
